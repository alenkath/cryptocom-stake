...
export class FeeSetterUpdated extends ethereum.Event {
  get params(): FeeSetterUpdated__Params {
    return new FeeSetterUpdated__Params(this);
  }
}

export class FeeSetterUpdated__Params {
  _event: FeeSetterUpdated;

  constructor(event: FeeSetterUpdated) {
    this._event = event;
  }

  get latestFeeSetter(): Address {
    return this._event.parameters[0].value.toAddress();
  }

  get previousFeeSetter(): Address {
    return this._event.parameters[1].value.toAddress();
  }
}

export class FeeToBasisPointUpdated extends ethereum.Event {
  get params(): FeeToBasisPointUpdated__Params {
    return new FeeToBasisPointUpdated__Params(this);
  }
}

export class FeeToBasisPointUpdated__Params {
  _event: FeeToBasisPointUpdated;

  constructor(event: FeeToBasisPointUpdated) {
    this._event = event;
  }

  get latestFeeToBasisPoint(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }

  get previousFeeToBasisPoint(): BigInt {
...
export class TotalFeeBasisPointUpdated extends ethereum.Event {
  get params(): TotalFeeBasisPointUpdated__Params {
    return new TotalFeeBasisPointUpdated__Params(this);
  }
}

export class TotalFeeBasisPointUpdated__Params {
  _event: TotalFeeBasisPointUpdated;

  constructor(event: TotalFeeBasisPointUpdated) {
    this._event = event;
  }

  get latestTotalFeeBasisPoint(): BigInt {
    return this._event.parameters[0].value.toBigInt();
  }

  get previousTotalFeeBasisPoint(): BigInt {
    return this._event.parameters[1].value.toBigInt();
  }
}
...
export class Contract extends ethereum.SmartContract {
  ...
  MAX_EVER_ALLOWED_TOTAL_FEE_BASIS_POINT(): BigInt {
    let result = super.call(
      "MAX_EVER_ALLOWED_TOTAL_FEE_BASIS_POINT",
      "MAX_EVER_ALLOWED_TOTAL_FEE_BASIS_POINT():(uint256)",
      []
    );
  ...
  try_MAX_EVER_ALLOWED_TOTAL_FEE_BASIS_POINT(): ethereum.CallResult<BigInt> {
